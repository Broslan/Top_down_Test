...
public class PlayerAnimationController : MonoBehaviour
{
    ...
    public void MouseLookAnimationHandler()
    {
        ...
        Vector2 lookDir = playerController.mousePos - new Vector2(playerController.aimAxis.position.x, playerController.aimAxis.position.y)/*playerController.playerMovmentController.rb.position*/;
