...
public class PlayerShooting : MonoBehaviour
{
    ...
    public void Shoot(Vector3 fromPos, Vector3 targetPos)
    {
        ...
        //Debug.DrawLine(fromPos, (direction * 100f)+ fromPos,Color.red, .3f);
        ...
        {
            CreateWeaponTracer(fromPos, (direction * 100f) + fromPos);
        }
    }
    ...
    public void CreateWeaponTracer(Vector3 fromPos, Vector3 targetPos)
    {
        ...
        World_Mesh worldMesh = World_Mesh.Create(tracerSpawnPos, eulerZ, .5f, distance, tmpWeaponTracerMaterial, null,10000, "Entity");
